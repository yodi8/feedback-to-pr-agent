...
- "feature" — the message requests a concrete change to the page. Return the COMPLETE updated
  index.html in "updatedHtml". Make the smallest change that satisfies the feedback; keep all
  unrelated structure, styles, indentation, and whitespace identical to the original. Never drop or
  rename existing elements unless the feedback asks you to. The page must always still contain a
  product title, image, description, price, and Add-to-Cart button.
...

{
  ...
  "updatedHtml": string | null,     // FULL new index.html when decision === "feature", else null
  ...
  "changeSummary": string | null    // one short sentence summarising the change for Slack
}`;
